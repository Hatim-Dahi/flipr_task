    ...
    <>
      <div className="sidebar-wrapper">
        ...
        <div className="dropdown-wrapper">
          ...
          <div className="image-trophy">
            <img src={trophy} alt="" />
            <h5 className='card-hearder'>Nobel Price Winners</h5>
          </div>       
        </div>
      </div>
      ...
      <div className="content-wrapper">
        <div className="header">
          <h4>Nobel Prize Award List</h4>
          <a href="#" data-toggle="modal" data-target="#createRiskModal">
            <div className="card">
              <button className='btn btn-light details-btn'>Details</button>
            </div>
          </a>
        </div>
      ...
      <div class="modal fade" id="createRiskModal" tabindex="-1" role="dialog" aria-labelledby="createRiskModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content add-risk-model">
          <div class="modal-header">
          <h4>Multiple-Time Nobel Prize Winners</h4><span className='tropy-model'><FaTrophy/></span>
                <button type="button" class="close model-clos-btn" data-dismiss="modal" aria-label="Close">
